...
<div id="category">
     <p>קטגוריה: <span><a href="../gallery/gallery.html?productCategory=${currentProduct.category}" id="categoryA"></a></span></p>
</div>
</div>`
...
document.getElementById('descrepition').innerHTML = currentProduct.descrepition;
